...
namespace ReSharperPlugin.DebugNotes.Rider.Model
{
  ...
  public class DebugNotesModel : RdExtBase
  {
    ...
    [NotNull] public IViewableProperty<ReSharperPlugin.DebugNotes.Rider.Model.MyEnum?> MyEnum => _MyEnum;
    [NotNull] public IViewableMap<string, string> Data => _Data;
    [NotNull] public ISignal<ReSharperPlugin.DebugNotes.Rider.Model.MyStructure> MyStructure => _MyStructure;
    
    //private fields
    [NotNull] private readonly RdProperty<string> _MyString;
    [NotNull] private readonly RdProperty<bool> _MyBool;
    [NotNull] private readonly RdProperty<ReSharperPlugin.DebugNotes.Rider.Model.MyEnum?> _MyEnum;
    [NotNull] private readonly RdMap<string, string> _Data;
    [NotNull] private readonly RdSignal<ReSharperPlugin.DebugNotes.Rider.Model.MyStructure> _MyStructure;
    
    //primary constructor
    private DebugNotesModel(
      [NotNull] RdProperty<string> myString,
      [NotNull] RdProperty<bool> myBool,
      [NotNull] RdProperty<ReSharperPlugin.DebugNotes.Rider.Model.MyEnum?> myEnum,
      [NotNull] RdMap<string, string> data,
      [NotNull] RdSignal<ReSharperPlugin.DebugNotes.Rider.Model.MyStructure> myStructure
    )
    {
    ...
    internal DebugNotesModel (
      ...
      new RdProperty<ReSharperPlugin.DebugNotes.Rider.Model.MyEnum?>(ReadMyEnumNullable, WriteMyEnumNullable),
      ...
      new RdSignal<ReSharperPlugin.DebugNotes.Rider.Model.MyStructure>(ReSharperPlugin.DebugNotes.Rider.Model.MyStructure.Read, ReSharperPlugin.DebugNotes.Rider.Model.MyStructure.Write)
    ) {}
    //deconstruct trait
    //statics
    
    public static CtxReadDelegate<ReSharperPlugin.DebugNotes.Rider.Model.MyEnum?> ReadMyEnumNullable = new CtxReadDelegate<ReSharperPlugin.DebugNotes.Rider.Model.MyEnum>(JetBrains.Rd.Impl.Serializers.ReadEnum<ReSharperPlugin.DebugNotes.Rider.Model.MyEnum>).NullableStruct();
    
    public static  CtxWriteDelegate<ReSharperPlugin.DebugNotes.Rider.Model.MyEnum?> WriteMyEnumNullable = new CtxWriteDelegate<ReSharperPlugin.DebugNotes.Rider.Model.MyEnum>(JetBrains.Rd.Impl.Serializers.WriteEnum<ReSharperPlugin.DebugNotes.Rider.Model.MyEnum>).NullableStruct();
    
    protected override long SerializationHash => 4921224948516967811L;
  ...
  /// <summary>
  /// <p>Generated from: DebugNotesModel.kt:17</p>
  /// </summary>
