...
// TODO: JetBrains doesn't recommend using forms anymore and suggests Kotlin DSL or BeControls instead.
// But it seems JCEF is not available for these solutions, so plain Swing seems to be the way to go.
